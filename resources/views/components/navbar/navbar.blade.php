<nav class="flex justify-between items-center p-16">
    <div>
        <h1 class="text-2xl font-bold"><span class="text-red-500">Campus&nbsp;</span>BrainShare</h1>
    </div>
    <div class="flex items-center relative">
        <input class="border rounded-full w-[550px] p-3 pl-5 pr-14" type="text" placeholder="Search Course eg. CSE247 ">
        <div class="absolute ml-[90%] ">
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" class="pre-nav-design-icon" focusable="false" viewBox="0 0 24 24" role="img" width="24px" height="24px" fill="none">
