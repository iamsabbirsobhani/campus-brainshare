<nav class="flex justify-between items-center p-16">
    ...
    <form action="/searchexpert" method="POST" class="flex items-center relative">
        @csrf
        <input class="outline-none border rounded-full w-[550px] p-3 pl-5 pr-14" type="text" placeholder="Search Course eg. CSE246 " required name="coursename" id="coursename">
        <button type="submit" class="absolute ml-[90%] hover:bg-gray-200 w-9 h-9 transition-all duration-300 rounded-full flex justify-center items-center cursor-pointer ">
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" class="pre-nav-design-icon text-gray-700" focusable="false" viewBox="0 0 24 24" role="img" width="24px" height="24px" fill="none">
